...
def get_args():
    ...
    parser.add_argument("--load-path", default=os.path.join(curdir, "load_model/SEV_efficientnet.pt"))
...
if __name__ == "__main__":
    ...
    model = torch.load(args.load_path, map_location={'cuda:0': 'cuda:1', 'cuda:2': 'cuda:1', 'cuda:3': 'cuda:1'}).to(device)
    ...
    def test():
        ...
        matchPath = '/mnt/sda1/tangzitian/FootballHighlights/games/[WCQ2022]China_vs_Philippines_2021-06-08/'
        ...
        np.save('classify_china.npy', total_prob)
    ...
    with torch.no_grad():
        ...
        total_savePath = '/mnt/sda1/songzimeng/Classifier_feature/'
